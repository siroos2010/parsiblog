...
if(count($_POST) && isset($_POST['title']) && !empty($_POST['category_id']) && isset($_POST['short_description'])  && isset($_POST['description']) ) {
    ...
    storePost($_POST['title'], $_POST['short_description'], $_POST['description'], $_POST['category_id'], $pic);
}
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form role="form" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">تصویر پست</label>
                    <input type="file" name="pic" class="form-control" id="" placeholder="عنوان پست را وارد کنید">
                </div>
                </div>
                <!-- /.card-body -->
