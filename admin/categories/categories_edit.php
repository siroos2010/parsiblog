...
if(count($_POST) && isset($_POST['id']) && isset($_POST['title'])) {
    $show_at_index = isset($_POST['show_at_index']) ? 1 : 0;
    updateCategory($_POST['id'], $_POST['title'], $show_at_index);
}

if(count($_GET) && isset($_GET['id']) && is_numeric($_GET['id'])) {
  $result = getCategories($_GET['id']);
              ...
              <form role="form" method="post" action="">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" id="exampleInputEmail1" placeholder="عنوان دسته بندی را وارد کنید" value="<?= $category['title'] ?>">
                  </div>
                    <div class="form-check">
                        <input type="checkbox" name="show_at_index" <?= $category['show_at_index'] ? 'checked' : '' ?> value="1" class="form-check-input" id="exampleCheck1">
